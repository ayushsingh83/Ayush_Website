  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-lg md:text-xl font-semibold">AI Recommendations</h2>
      ...
      <GlassCard className="p-5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row gap-6">
          <div className="flex-1 space-y-4">
            <div className="inline-flex items-center gap-2 rounded-3xl bg-slate-900/70 border border-neonCyan/40 px-3 py-1.5 text-xs text-slate-200">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-3xl bg-slate-900/80 border border-slate-700/70">
          ...
          <div className="w-full lg:w-72 space-y-4">
            <div className="rounded-3xl bg-slate-950/80 border border-slate-700/70 p-3 space-y-3">
              <div className="flex items-center justify-between gap-2">
                <span className="text-xs text-slate-400">Sparkle feed</span>
